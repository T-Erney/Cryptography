...
Mat44* add_round_key(Mat44* m, Mat44* k) {
  Mat44* n = mat44_set(
    {m->data[0][0] ^ k->data[0][0], m->data[0][1] ^ k->data[0][1], m->data[0][2] ^ k->data[0][2], m->data[0][3] ^ k->data[0][3]},
    {m->data[1][0] ^ k->data[1][0], m->data[1][1] ^ k->data[1][1], m->data[1][2] ^ k->data[1][2], m->data[1][3] ^ k->data[1][3]},
    {m->data[2][0] ^ k->data[2][0], m->data[2][1] ^ k->data[2][1], m->data[2][2] ^ k->data[2][2], m->data[2][3] ^ k->data[2][3]},
    {m->data[3][0] ^ k->data[3][0], m->data[3][1] ^ k->data[3][1], m->data[3][2] ^ k->data[3][2], m->data[3][3] ^ k->data[3][3]}
  );
  return n;
}
